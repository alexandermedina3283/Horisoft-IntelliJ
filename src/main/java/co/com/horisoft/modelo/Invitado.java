...
public class Invitado {
    ...
    public Invitado(int idInvitado, String nombreInvitado, String apellidoInvitado, String identificacionInvitado, int idInscripcion) {
    ...
    public String toString() {
        return "Invitado{" +
                ...
                ", identificacionInvitado='" + identificacionInvitado + '\'' +
