        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="http://localhost:8080/Horisoft_war_exploded/index.jsp"><i class="fas fa-home"></i>Inicio</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="http://localhost:8080/Horisoft_war_exploded/ResidenteServlet?opcion=listarResidente">Residentes</a></li>
