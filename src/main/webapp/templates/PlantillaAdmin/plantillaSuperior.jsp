...
<div class="wrapper">
    ...
    <header class="main-header-top hidden-print">
        <a href="#" class="logo"><img class="img-fluid able-logo" src="<%=request.getContextPath()%>/templates/PlantillaAdmin/assets/images/LogoHorisoftBlack2-04.png" alt="Theme-logo"></a>
