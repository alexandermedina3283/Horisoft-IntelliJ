                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input class="form-control" name="placaVehiculo" id="placaVehiculo" value="${parqueadero.placaVehiculo}" type="text" placeholder="Placa vehículo" required pattern="[A-Z0-9]{2,6}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-10">
                                        ...
                                        <input class="form-control" name="colorVehiculo" id="colorVehiculo" value="${parqueadero.colorVehiculo}" type="text" placeholder="ej.Plata" />
                                    </div>
                                </div>
                                <div class="form-group row">
