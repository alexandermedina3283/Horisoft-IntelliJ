                        ...
                        <table class="table">
                            ...
                            <c:forEach var="mascota" items="${lista}">
                                ...
                                <tr>
                                    ...
                                    <td><a type="button" data-toggle="modal" data-target="#myModal<c:out value="${mascota.idMascota}"></c:out>"> <i class="far fa-trash-alt" style="color: black;"></i></a></td>
                                ...
                                <!-- start modal content -->
                                <div id="myModal<c:out value="${mascota.idMascota}"></c:out>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>¿Esta seguro que desea eliminar los datos de la mascota número <c:out value="${mascota.idMascota}"></c:out> de forma permanente?</p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Cancelar</button>
                                                <a type="button" class="btn btn-warning waves-effect waves-light" href="MascotaServlet?opcion=eliminar&idMascota=<c:out value="${mascota.idMascota}"></c:out>">Continuar</a>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
                                </div><!-- /.modal -->
