...
<a class="btn btn-danger float-end mx-2 mb-1 mt-3 p-2" href="http://localhost:8080/Horisoft_war_exploded/InvitadoServlet?opcion=crearInvitado" role="button">Crear nuevo registro</a>
