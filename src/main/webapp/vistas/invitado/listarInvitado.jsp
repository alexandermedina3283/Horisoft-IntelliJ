...
<table class="table">
    ...
    <c:forEach var="invitado" items="${lista}">
        <tr>
            ...
            <td><a href="http://localhost:8080/Horisoft_war_exploded/InvitadoController?opcion=eliminar&idInvitado=<c:out value="${invitado.idInvitado}"></c:out>">Eliminar</a></td>
            <td><a href="http://localhost:8080/Horisoft_war_exploded/InvitadoController?opcion=editar&idInvitado=<c:out value="${invitado.idInvitado}"></c:out>">Editar</a></td>
        </tr>
    </c:forEach>
