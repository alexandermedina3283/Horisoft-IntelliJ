...
<table class="table">
    ...
    <c:forEach var="inscripcion" items="${lista}">
        <tr>
            ...
            <td><a href="http://localhost:8080/Horisoft_war_exploded/InscripcionController?opcion=eliminar&idInscripcion=<c:out value="${inscripcion.idInscripcion}"></c:out>"><i class="far fa-trash-alt"></i></a></td>
            <td><a href="http://localhost:8080/Horisoft_war_exploded/InscripcionController?opcion=editar&idInscripcion=<c:out value="${inscripcion.idInscripcion}"></c:out>"><i class="far fa-edit"></i></a></td>
        </tr>
    </c:forEach>
